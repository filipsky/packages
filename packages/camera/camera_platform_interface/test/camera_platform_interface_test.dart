...
void main() {
  ...
  group('$CameraPlatform', () {
    ...
    test('Default implementation of createCameraWithSettings() should call createCamera() passing parameters', () {
      ...
      expect(createCameraCalled, isTrue, reason: 'default implementation of createCameraWithSettings should call createCamera passing parameters');
    });
...
class OverriddenCameraPlatform extends CameraPlatform {
  ...
  @override
  Future<int> createCamera(CameraDescription cameraDescription, ResolutionPreset? resolutionPreset, {bool enableAudio = false}) {
